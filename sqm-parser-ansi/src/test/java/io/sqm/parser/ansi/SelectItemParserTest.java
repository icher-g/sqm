...
class SelectItemParserTest {
    ...
    void name_only() {
        ...
        ColumnExpr n = item.expr().asColumn();
    ...
    class Happy {
        ...
        void nested_case_in_then() {
            ...
            var outer = pr.value().expr().asCase();
