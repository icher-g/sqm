...
public final class Parsers {
    ...
    private static ParsersRepository registerDefaults(ParsersRepository r) {
        ...
        return r
            ...
            .register(new HierarchicalQueryClauseParser())
            ...
            .register(new MergeActionParser())
            ...
            .register(new ResultItemParser())
            .register(new StarSelectItemParser())
            .register(new StarResultItemParser())
            .register(new QualifiedStarSelectItemParser())
            .register(new QualifiedStarResultItemParser())
            ...
            .register(new PatternMeasureParser())
            .register(new RowsPerMatchParser())
            .register(new AfterMatchSkipParser())
            .register(new PatternSubsetParser())
            .register(new PatternDefinitionParser())
            .register(new MatchPatternParser())
            .register(new PatternVariableParser())
            .register(new PatternSequenceParser())
            .register(new PatternAlternationParser())
            .register(new PatternPermutationParser())
            .register(new PatternAnchorParser())
            .register(new EmptyPatternParser())
            .register(new PatternExclusionParser())
            .register(new QuantifiedPatternParser())
            .register(new PatternColumnExprParser())
            .register(new ClassifierExprParser())
            .register(new MatchNumberExprParser())
            .register(new PatternNavigationExprParser())
            .register(new PatternEvaluationExprParser())
