...
/**
 * Parses qualified star result items such as {@code t.*}.
 */
public class QualifiedStarResultItemParser implements MatchableParser<QualifiedStarResultItem> {
    /**
     * Creates a qualified-star result-item parser.
     */
    public QualifiedStarResultItemParser() {
    }
     ...
     */
    @Override
    public ParseResult<QualifiedStarResultItem> parse(Cursor cur, ParseContext ctx) {
        ...
        return ok(ResultItem.star(toIdentifier(t)));
    }
