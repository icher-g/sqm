...
public class MixInsSmokeTest {
    ...
    void buildsMapper() {
        ObjectMapper m = SqlModelMapperFactory.createDefault();
        assertNotNull(m);
    }
    ...
    void functionArgs_polymorphic_roundTrip() throws Exception {
        ...
        io.cherlabs.sqlmodel.core.FunctionColumn fc =
                m.readValue(json, io.cherlabs.sqlmodel.core.FunctionColumn.class);
    ...
    void column_serialization_minimal() throws Exception {
        ...
        io.cherlabs.sqlmodel.core.Column c =
                m.readValue(json, io.cherlabs.sqlmodel.core.Column.class);
    ...
    void filter_serialization_minimal() throws Exception {
        ...
        io.cherlabs.sqlmodel.core.Filter f =
                m.readValue(json, io.cherlabs.sqlmodel.core.Filter.class);
    ...
    void join_serialization_minimal() throws Exception {
        ...
        io.cherlabs.sqlmodel.core.Join j =
                m.readValue(json, io.cherlabs.sqlmodel.core.Join.class);
    ...
    void table_serialization_minimal() throws Exception {
        ...
        io.cherlabs.sqlmodel.core.Table t =
                m.readValue(json, io.cherlabs.sqlmodel.core.Table.class);
    ...
    void values_serialization_minimal() throws Exception {
        ...
        io.cherlabs.sqlmodel.core.Values v =
                m.readValue(json, io.cherlabs.sqlmodel.core.Values.class);
