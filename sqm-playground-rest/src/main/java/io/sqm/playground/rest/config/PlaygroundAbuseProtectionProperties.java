...
/**
 * Abuse-protection properties for playground REST endpoints.
 */
@ConfigurationProperties(prefix = "sqm.playground.rest.abuse")
public class PlaygroundAbuseProtectionProperties {

    private boolean rateLimitEnabled = true;
    private int requestsPerWindow = 20;
    private int windowSeconds = 60;
    private long maxRequestBytes = 16 * 1024;
     ...
     */
    public PlaygroundAbuseProtectionProperties() {
    }
