...
/**
 * Enforces fixed-window rate limits for playground REST endpoints when enabled.
 */
public final class RateLimitInterceptor implements HandlerInterceptor {

    private final PlaygroundAbuseProtectionProperties properties;
     ...
     */
    public RateLimitInterceptor(PlaygroundAbuseProtectionProperties properties, FixedWindowRateLimiter limiter) {
