...
/**
 * Unit tests for {@link SubArithmeticExprRenderer}.
 *
 * <p>These tests verify that the renderer:
 * <ul>
 *     <li>Renders simple subtraction without unnecessary parentheses.</li>
 ...
 */
class SubArithmeticExprRendererTest {
    ...
    @Test
    void renders_simple_sub_without_parentheses() {
        // a - b
    ...
    @Test
    void renders_left_nested_sub_with_parentheses() {
        // (a - b) - c
    ...
    @Test
    void renders_right_nested_sub_with_parentheses() {
        // a - (b - c)
