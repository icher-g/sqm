 ...
 * Array expressions are not supported in ANSI SQL, so an UnsupportedOperationException should be thrown.
 */
class ArrayExprRendererTest {
    ...
    @Test
    @DisplayName("Array expression throws UnsupportedOperationException")
    void array_expr_throws_exception() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> renderer.render(null, ctx, null), "Array expressions should not be supported in ANSI SQL");
    }

    @Test
    @DisplayName("UnsupportedOperationException has descriptive message")
    void exception_message_is_descriptive() {
        UnsupportedOperationException ex = assertThrows(UnsupportedOperationException.class, () -> renderer.render(null, ctx, null));
        String message = ex.getMessage();
        assertTrue(message != null && message.contains("Array")
        );
    }
