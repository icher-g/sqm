 ...
 */
public class SqlServerOutputColumnExprParser implements MatchableParser<OutputColumnExpr> {

    /**
     * Creates a SQL Server output-column parser.
     */
    public SqlServerOutputColumnExprParser() {
    }
    ...
    public ParseResult<OutputColumnExpr> parse(Cursor cur, ParseContext ctx) {
        ...
        var column = toIdentifier(cur.expect("Expected output column name", TokenType.IDENT));
