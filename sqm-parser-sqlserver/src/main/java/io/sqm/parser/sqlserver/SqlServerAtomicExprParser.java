 ...
 */
public class SqlServerAtomicExprParser extends AtomicExprParser {

    /**
     * Creates a SQL Server atomic-expression parser.
     */
    public SqlServerAtomicExprParser() {
    }

    /**
     * Attempts to parse SQL Server output pseudo-columns before falling back to
