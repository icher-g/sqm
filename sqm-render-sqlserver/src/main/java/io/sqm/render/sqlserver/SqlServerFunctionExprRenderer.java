...
import io.sqm.render.ansi.FunctionExprRenderer;
 ...
 */
public class SqlServerFunctionExprRenderer extends FunctionExprRenderer {
    /**
     * Creates a SQL Server function renderer.
     */
    public SqlServerFunctionExprRenderer() {
    }
