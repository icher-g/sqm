...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = PatternColumnExpr.Impl.class, name = "pattern-column"),
    @JsonSubTypes.Type(value = ClassifierExpr.Impl.class, name = "classifier"),
    @JsonSubTypes.Type(value = MatchNumberExpr.Impl.class, name = "match-number"),
    @JsonSubTypes.Type(value = PatternNavigationExpr.Impl.class, name = "pattern-navigation"),
    @JsonSubTypes.Type(value = PatternEvaluationExpr.Impl.class, name = "pattern-evaluation"),
