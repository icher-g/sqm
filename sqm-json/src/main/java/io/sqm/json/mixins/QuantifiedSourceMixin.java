...
/**
 * Jackson mixin root for quantified ANY/ALL source polymorphism.
 */
...
public abstract class QuantifiedSourceMixin extends CommonJsonMixin {

    /**
     * Creates quantified-source mixin metadata.
     */
    protected QuantifiedSourceMixin() {
    }
}
