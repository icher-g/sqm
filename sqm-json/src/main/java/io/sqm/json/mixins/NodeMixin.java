...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = OutputClause.Impl.class, name = "outputClause"),
    @JsonSubTypes.Type(value = OutputItem.Impl.class, name = "outputItem"),
    @JsonSubTypes.Type(value = OutputInto.Impl.class, name = "outputInto"),
