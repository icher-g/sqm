...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = PatternMeasure.Impl.class, name = "patternMeasure"),
    @JsonSubTypes.Type(value = PatternDefinition.Impl.class, name = "patternDefinition"),
    @JsonSubTypes.Type(value = PatternSubset.Impl.class, name = "patternSubset"),
    @JsonSubTypes.Type(value = RowsPerMatch.Impl.class, name = "rowsPerMatch"),
    @JsonSubTypes.Type(value = AfterMatchSkip.Impl.class, name = "afterMatchSkip"),
    @JsonSubTypes.Type(value = PivotMeasure.Impl.class, name = "pivotMeasure"),
    @JsonSubTypes.Type(value = PivotValue.Impl.class, name = "pivotValue"),
    @JsonSubTypes.Type(value = TableVersionSpec.Impl.class, name = "tableVersion"),
    @JsonSubTypes.Type(value = TablePartitionSpec.Impl.class, name = "tablePartition"),
    @JsonSubTypes.Type(value = TableSampleSpec.Impl.class, name = "tableSample"),
    @JsonSubTypes.Type(value = UnpivotInput.Impl.class, name = "unpivotInput"),
