...
/**
 * Thin MCP-facing adapter that delegates to {@link SqlMiddlewareService}.
 */
public final class SqlMiddlewareMcpAdapter {
     ...
     */
    public SqlMiddlewareMcpAdapter(SqlMiddlewareService service) {
        this.service = Objects.requireNonNull(service, "service must not be null");
    }

    /**
     * Handles MCP analyze tool requests.
     *
    ...
    /**
     * Handles MCP enforce tool requests.
     *
    ...
    /**
     * Handles MCP explain tool requests.
     *
