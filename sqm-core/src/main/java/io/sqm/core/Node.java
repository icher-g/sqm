 ...
 * </p>
 */
public sealed interface Node extends Serializable permits Assignment, BoundSpec, CteDef, DialectNode, DistinctSpec, Expression, FrameSpec, FromItem, GroupBy, GroupItem, InsertSource, LimitOffset, LockingClause, OrderBy, OrderItem, ResultClause, ResultInto, ResultItem, OverSpec, PartitionBy, SelectItem, Statement, TopSpec, TypeName, WhenThen, WindowDef {
    /**
