 ...
 * </p>
 */
public sealed interface Node extends Serializable permits BoundSpec, CteDef, DialectNode, DistinctSpec, Expression, FrameSpec, FromItem, GroupBy, GroupItem, LimitOffset, OrderBy, OrderItem, OverSpec, PartitionBy, Query, SelectItem, WhenThen, WindowDef, TypeName {
    /**
