 ...
 * </p>
 */
public sealed interface Node extends Serializable permits Assignment, BoundSpec, CteDef, DialectNode, DistinctSpec, Expression, FrameSpec, FromItem, GroupBy, GroupItem, Hint, HintArg, InsertSource, LimitOffset, LockingClause, MergeAction, MergeClause, OrderBy, OrderItem, QuantifiedSource, ResultClause, ResultTarget, ResultItem, OverSpec, PartitionBy, SelectItem, StatementSequence, Statement, TopSpec, TypeName, WhenThen, WindowDef {
    /**
