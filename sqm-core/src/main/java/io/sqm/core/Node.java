 ...
 * </p>
 */
public sealed interface Node extends Serializable permits AfterMatchSkip, Assignment, BoundSpec, CteDef, DialectNode, DistinctSpec, Expression, FrameSpec, FromItem, GroupBy, GroupItem, HierarchicalQueryClause, Hint, HintArg, InsertSource, JsonTableBehavior, JsonTableColumn, LimitOffset, LockingClause, MatchPattern, MergeAction, MergeClause, OrderBy, OrderItem, PatternDefinition, PatternMeasure, PatternSubset, PivotMeasure, PivotValue, QuantifiedSource, ResultClause, ResultTarget, ResultItem, RowsPerMatch, OverSpec, PartitionBy, SelectItem, StatementSequence, Statement, TablePartitionSpec, TableSampleSpec, TableVersionSpec, TopSpec, TypeName, UnpivotInput, WhenThen, WindowDef {
    /**
