...
public interface Filter extends Entity {
    ...
    /**
     * Creates a composite filter with an {@link CompositeFilter.Operator#And} op.
     *
    ...
    /**
     * Creates a composite filter with an {@link CompositeFilter.Operator#Or} op.
     *
     * @param filters an array of filters to compose.
     * @return A newly created instance of a filter.
     */
    ...
    /**
     * Creates a composite filter with an {@link CompositeFilter.Operator#Not} op.
     *
