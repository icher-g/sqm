...
class LockingClauseTest {
    ...
    void createWithOfTables() {
        ...
        assertEquals("users", clause.ofTables().get(0).identifier());
        assertEquals("orders", clause.ofTables().get(1).identifier());
    }
    ...
    void ofTablesIsCopied() {
        ...
        mutableList.add(LockTarget.of("users"));
        ...
        mutableList.add(LockTarget.of("orders"));
        assertEquals(1, clause.ofTables().size());
        
        // Verify immutability
        assertThrows(UnsupportedOperationException.class, 
            () -> clause.ofTables().add(LockTarget.of("products")));
    }
    ...
    void complexClause() {
        var targets = List.of(LockTarget.of("t1"), LockTarget.of("t2"));
