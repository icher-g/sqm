...
class MergeActionMatchTest {
    ...
    void matchesUpdateDeleteAndInsertActions() {
        ...
        MergeAction doNothing = io.sqm.core.MergeDoNothingAction.of();
        ...
        assertEquals("DO NOTHING", Match.<String>mergeAction(doNothing).doNothing(i -> "DO NOTHING").otherwise(ignored -> "OTHER"));
